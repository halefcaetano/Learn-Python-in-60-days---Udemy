...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = '''This app was created during the course "The Python Mega Course". Feel free to modify and reuse
        this app.'''
...
class EditDialog(QDialog):
    def __init__(self):
        ...
        self.student_id = main_window.table.item(index, 1).text()
...
class DeleteDialog(QDialog):
    def __init__(self):
        ...
        layout = QGridLayout()
        confirmation = QLabel('Are you sure you want delete?')
        yes = QPushButton('Yes')
        no = QPushButton('No')
